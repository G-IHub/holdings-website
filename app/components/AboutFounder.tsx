...
import founderImg from "../../assets/about/ceo.png";
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-700 max-md:text-base leading-relaxed text-xl mb-4">
            ...
            <p className="text-gray-700 max-md:text-base leading-relaxed text-xl mb-6">
